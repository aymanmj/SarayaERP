  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_button: "h-9 w-9 p-0 font-medium aria-selected:opacity-100 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg flex items-center justify-center transition-all cursor-pointer m-auto",
        selected: "bg-sky-500 !text-white hover:bg-sky-400 font-bold shadow-lg shadow-sky-500/30",
        today: "text-sky-400 font-bold border border-sky-500/50 bg-sky-500/10",
