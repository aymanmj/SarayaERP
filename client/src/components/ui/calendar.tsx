  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-bold text-white hidden", // إخفاء النص العادي لإظهار القوائم
        caption_dropdowns: "flex justify-center gap-1 z-50", // تنسيق القوائم
        dropdown:
          "bg-slate-900 border border-slate-700 text-white text-xs rounded-md p-1 outline-none focus:border-sky-500",
        nav: "space-x-1 flex items-center",
        button_previous:
          "absolute left-1 h-7 w-7 bg-transparent p-0 opacity-100 hover:bg-slate-800 text-white rounded-md flex items-center justify-center border border-slate-700 transition-colors z-10",
        button_next:
          "absolute right-1 h-7 w-7 bg-transparent p-0 opacity-100 hover:bg-slate-800 text-white rounded-md flex items-center justify-center border border-slate-700 transition-colors z-10",
        ...
        day_button:
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-white hover:bg-slate-700 hover:text-white rounded-md flex items-center justify-center transition-colors cursor-pointer",
        selected:
