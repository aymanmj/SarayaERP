    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-4 mb-4">
      <div className="flex justify-between items-center mb-4">
        ...
        {!disabled && (
          <div className="flex items-center space-x-2 space-x-reverse">
            <span className="text-sm text-gray-600 dark:text-gray-400">نص حر</span>
            <button
            ...
            <span className="text-sm text-gray-600 dark:text-gray-400">مهيكل (SOAP)</span>
          </div>
        )}
      </div>
      ...
      <div className="space-y-4">
        {isStructured ? (
          <>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Subjective (S)</label>
              <textarea
                value={subjective}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Objective (O)</label>
              <textarea
                value={objective}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Assessment (A)</label>
              <textarea
                value={assessment}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Plan (P)</label>
              <textarea
                value={plan}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">تفاصيل الملاحظة المفتوحة</label>
            <textarea
              value={content}
