...
//     // ✅ [FIX] منع فتح حالة تنويم جديدة إذا كان المريض منوماً بالفعل
//     if (data.type === EncounterType.IPD) {
//       const activeIpd = await this.prisma.encounter.findFirst({
//         where: {
//           hospitalId,
...
//     // ✅ لو فيه departmentId، تأكد إن القسم موجود
...
//       if (!dept) {
//         throw new NotFoundException('القسم غير موجود في هذه المنشأة');
//       }

//       departmentId = dept.id;
//     }

//     // (اختياري لاحقًا: نتحقق من doctorId بنفس الطريقة)
...
//     if (!enc) {
//       throw new NotFoundException('الملف الطبي (Encounter) غير موجود');
//     }
...
//       throw new BadRequestException('لا يمكن إغلاق Encounter في هذه الحالة');
//     }
...
//           isDeleted: false,
//         },
//         extraUpdateData: {}, // ما عندنا isActive هنا (لو أضفتها تقدر تستخدمها)
//       },
//       userId,
//     );
//   }
