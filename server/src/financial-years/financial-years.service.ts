...
//   // توليد فترات شهرية تلقائيًا لسنة مالية
//   async generateMonthlyPeriods(
//     hospitalId: number,
//     yearId: number,
//     userId: number,
...
//       const periodCode = `${monthStart.getFullYear()}-${String(
...
//   // جلب الفترة المفتوحة لتاريخ معيّن
//   // 🔍 إيجاد سنة مالية حالية مفتوحة + فترة مفتوحة تشمل التاريخ
//   async getOpenPeriodForDate(hospitalId: number, date: Date) {
