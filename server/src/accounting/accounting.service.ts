...
const SAMPLE_COA: SampleAccountDef[] = [
  // ===== الأصول =====
  { code: '100000', name: 'الأصول المتداولة', type: AccountType.ASSET },
  ...
  { code: '140000', name: 'أصول متداولة أخرى', type: AccountType.ASSET },
  {
  ...
  { code: '150000', name: 'الأصول الثابتة', type: AccountType.ASSET },
  {
    code: '150100',
  ...
  { code: '160000', name: 'مجمع الإهلاك', type: AccountType.CONTRA_ASSET },
  {
    code: '160100',
  ...
  // ===== الالتزامات =====
  { code: '200000', name: 'الالتزامات المتداولة', type: AccountType.LIABILITY },
  {
    code: '200100',
  ...
  // ===== حقوق الملكية =====
  { code: '300000', name: 'حقوق الملكية', type: AccountType.EQUITY },
  {
    code: '300100',
    name: 'رأس المال',
  ...
  // ===== الإيرادات =====
  { code: '400000', name: 'إيرادات التشغيل', type: AccountType.REVENUE },
  {
  ...
  // ===== المصروفات =====
  { code: '500000', name: 'مصروفات تشغيلية', type: AccountType.EXPENSE },
  {
    code: '500100',
    name: 'رواتب وأجور',
  ...
  { code: '510000', name: 'مصروفات إدارية وعمومية', type: AccountType.EXPENSE },
  {
    code: '510100',
    name: 'إيجار',
    type: AccountType.EXPENSE,
