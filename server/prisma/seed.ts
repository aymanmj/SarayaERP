...
//   await createUser('admin', 'System Admin', ['ADMIN', 'IT_ADMIN']);
//   await createUser('dr_internal', 'د. محمد الفاتح (باطنة)', ['DOCTOR'], true);
//   await createUser('dr_surgeon', 'د. يوسف الجراح (جراحة)', ['DOCTOR'], true);
//   await createUser('lab_tech', 'فني المختبر', ['LAB_TECH']);
//   await createUser('rad_tech', 'فني الأشعة', ['RAD_TECH']);
//   await createUser('pharm_user', 'د. صيدلي', ['PHARMACIST']);
//   await createUser('cashier_1', 'أحمد الكاشير', ['CASHIER']);
//   await createUser('nurse_1', 'الممرضة سارة', ['NURSE']);
